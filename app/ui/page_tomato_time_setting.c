...
void init_page_tomatotime_setting()
{
    ...
    lv_obj_align_to(study_setting_view,title_view,LV_ALIGN_OUT_BOTTOM_LEFT,50,10);
    lv_obj_t * rest_setting_view = init_setting_param_view(cont,TOMATO_TYPE_REST);
    lv_obj_align_to(rest_setting_view,study_setting_view,LV_ALIGN_OUT_RIGHT_MID,100,0);
