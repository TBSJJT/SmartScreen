...
void init_page_alarm_clock_setting()
{
    ...
    lv_obj_align_to(time_view,title_view,LV_ALIGN_OUT_BOTTOM_LEFT,20,30);
    ...
    lv_obj_align_to(time_view_label, time_view_btn,LV_ALIGN_OUT_BOTTOM_MID,0,30);
    lv_obj_add_flag(time_view_label,LV_OBJ_FLAG_HIDDEN);

    lv_obj_t * hm_time_view = init_setting_param_view_hm(cont,1);
    lv_obj_align_to(hm_time_view,time_view,LV_ALIGN_OUT_RIGHT_MID,250,0);
