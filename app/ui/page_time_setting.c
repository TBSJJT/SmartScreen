...
static void init_item_view(lv_obj_t *parent,TIME_SHOW_TYPE_E type){
    if(type == TIME_TYPE_1){
        ...
        lv_label_set_text(weather_obj,"杨凌 小雨 12°C");
...
void init_page_time_setting()
{
    ...
    lv_obj_align(bg_img,LV_ALIGN_BOTTOM_RIGHT,-2,0);
    
    lv_obj_t * setting_param_view = init_setting_param_view(cont);
    lv_obj_align_to(setting_param_view,title_view,LV_ALIGN_OUT_BOTTOM_LEFT,20,10);
